...
def decode_predictions(predictions, image_w, image_h, input_w=YOLO3.width, input_h=YOLO3.height, min_score=0.5):
    boxes, output = [], []
...
def draw_boxes(filename, boxes, name, figsize=(12, 8)):
